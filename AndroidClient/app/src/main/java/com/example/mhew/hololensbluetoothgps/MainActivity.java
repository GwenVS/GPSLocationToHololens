...
public class MainActivity extends AppCompatActivity {
    ...
    public void startGPS() {
        ...
        try {
            ...
            //TODO: ??
            Toast.makeText(MainActivity.this, "securityException in locationService", Toast.LENGTH_SHORT)
                    .show();
        } catch (Exception e) {
            Toast.makeText(MainActivity.this, "please enable Location settings", Toast.LENGTH_LONG)
                    .show();
        }
    }
    ...
    public void UpdatePosition(Location location) {
        ...
        System.out.println(new SimpleDateFormat("HH.mm.ss").format(new Date()) + " : lat: " + Double.toString(currentLocation.getLatitude()) + " , long: " + Double.toString(currentLocation.getLongitude()));
        restartAdvertising(BEACON_ID, buildGPSPacket(location));
    }

    private byte[] buildGPSPacket(Location location) {
